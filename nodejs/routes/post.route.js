...
router.post('/create', auth.guard, validator.post, validator.handleValidationErrors, postController.createPost);
router.put('/update', auth.guard, validator.post, validator.handleValidationErrors, postController.updatePost);
