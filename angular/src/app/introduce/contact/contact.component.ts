...
export class ContactComponent implements OnInit {
  ...
  ngOnInit(): void {
    this.contact = [
      ...
      {
        title: 'address',
        content: 'nhu quynh-van lam-hung yen',
        class: 'fa fa-map-marker',
      },
      {
        title: 'facebook',
        content: 'facebook.com/son.tranxuan.10',
        class: 'fa fa-facebook-square',
      },
      {
        title: 'email',
        content: 'tranxuanson1503@gmail.com',
        class: 'fa fa-envelope-open',
      },
      {
        title: 'github',
        content: 'github.com/jasontran1503',
        class: 'fa fa-github',
      },
      {
        title: 'university',
        content: 'water resources university',
